...
-19 213 -120 157z"></path>
  ...
  <div class="overflow-hidden"><div class=" h-64 bg-burgundy transform transition duration-700 hover:scale-110"><img :src="`${$config.baseURL}images/diwali.jpg`"></div></div>
    <div class="overflow-hidden"><div class=" bg-burgundy h-64 transition transform duration-700 hover:scale-110"><img class="h-64 w-full object-cover object-center" :src="`${$config.baseURL}images/IMG_20230902_201812899.jpg`"></div></div>
