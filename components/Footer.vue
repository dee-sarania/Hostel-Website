<template>
  <div class="bg-burgundy">
    <div class="container justify-center items-center ml-14 py-14 text-white md:text-left px-6">
      <!-- DOWNLOAD LINKS -->
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-16 gap-x-10">
        <div class="text-white col-span-2 md:col-span-3 lg:col-span-2">
          <h6 class="font-semibold mb-2 text-2xl">Jiri Women's Hostel</h6>
          <h6>Tezpur University,<br>Napaam, Tezpur, Assam <br>PIN - 784028</h6>
          <p class="flex items-center mt-4 mb-4">
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope" class="w-4 mr-2.5"
              role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path fill="currentColor"
                d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z">
              </path>
            </svg>
            <a href="mailto:jiriwomenshostel@gmail.com" class="hover:underline">jiriwomenshostel@gmail.com</a>
          </p>
        ...
        <div>
          ...
          <p class="mb-2"> >
            <a :href="`${$config.baseURL}docu/Hostel_Accomodation_Form.pdf`" class="hover:text-red-200" target="_blank">Guest Accomodation</a> 
          </p>          
        </div>

        <!-- UNIVERSITY LINKS -->
        <div>
          <h6 class="uppercase font-semibold mb-4 text-white flex justify-start">
            UNIVERSITY LINKS
          </h6>
          <p class="mb-2"> >
...
-15 304 21 416 94 298 345 525 644 585 89 18 243 18 333 1z"></path>
    ...
    <!-- COPYRIGHT -->
    <div class="border-t border-light_pink bg-burgundy text-white py-2 px-6">
      <span class="container flex justify-center align-center py-2 text-sm">© Copyright 2022: Jiri Women's Hostel,
        Tezpur University, Napaam, Tezpur-784028</span>
    </div>
