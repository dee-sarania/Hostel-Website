        ...
        <div class="card flex justify-center lg:flex-row flex-col-reverse outline-none m-8">
          <div
            ...
            <div class="col-span-3 sm:col-span-1">
              <img class="h-24" :src="`${$config.baseURL}icons/logo.png`" alt="">
            </div>
            ...
            <div class="flex flex-wrap col-span-3 mt-10">
              <div class="w-full sm:w-1/3 mb-10 lg:mb-0">
                ...
                <p class="flex items-center md:justify-start hover:underline mt-2">
                  ...
                  <a href="mailto:saona@tezu.ernet.in"
                  class="hover:underline hover:text-red-100">saona@tezu.ernet.in</a>
                </p>
              </div>
              <div class="w-full sm:w-1/3 mb-10 lg:mb-0">
                ...
                <p class="flex items-center md:justify-start hover:underline mt-2">
                 <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope" class="mr-2 h-4"
                  ...
                  <a href="mailto: poonam@tezu.ernet.in"
                  class="hover:underline hover:text-red-100"> poonam@tezu.ernet.in</a>      
                </p>
              </div>
              <div class="w-full sm:w-1/3">
                ...
                <p class="flex items-center md:justify-start hover:underline mt-2">
                 ...
                 <a href="mailto: msi18009@tezu.ernet.in"
                  class="hover:underline hover:text-red-100"> msi18009@tezu.ernet.in</a>
                </p>
              </div>
            </div>
          </div>
          <div class="map h-96 lg:h-auto mb-10 lg:mb-0 lg:w-3/6">
            <iframe class="rounded-2xl lg:rounded-r-2xl lg:rounded-l-none"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3564.268475324649!2d92.8306125148168!3d26.70386878321797!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3744ebbece98dffd%3A0x26123178980bfca4!2sJiri%20Path%2C%20Napaam%2C%20Amola%20Pam%20Gaon%2C%20Assam%20784028!5e0!3m2!1sen!2sin!4v1658437584868!5m2!1sen!2sin"
