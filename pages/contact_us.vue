  ...
  <div class="header-margin pb-64">
    ...
    <div class="container w-auto">
      ...
      <div class="card grid grid-cols-3 border rounded-2xl outline-none m-8">
        <div class="contact bg-burgundy col-span-2 p-10 justify-items-center text-white grid grid-cols-3 border rounded-l-2xl p-14">
           
            <div class="one m-8">
                  <img src="/icons/logomain.jpeg" alt="">
            </div>
            <div class="two col-span-2 m-12">
              ...
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
                class="mr-2.5 h-5" role="img" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512">
                <path fill="currentColor"
