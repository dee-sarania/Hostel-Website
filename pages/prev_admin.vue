<template>
       ...
       <div class="container">
         ...
         <div>
            <div class="flex mt-16 mb-12 pb-4 space-x-10 border-b-2">
               <div class="text-2xl font-semibold capitalize hover:text-burgundy text-gray-400"><nuxt-link to="/administration" class="">Current</nuxt-link></div>
               <div class="text-2xl font-semibold capitalize hover:text-burgundy text-burgundy  text-center"><nuxt-link to="/prev_admin">Previous</nuxt-link></div>
            </div>
 ...
 <script>
 import { wardens, prefects, officeStaffs, messConvenors, webTeams } from './../data/prev_admin.js';
 export default {
    data() {
     return {
          wardens,
