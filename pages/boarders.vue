<template>
  <div class="pt-32 lg:pt-72 pb-32">
    <div class="container px-6">
      ...
      <p class="mt-4 text-para font-semibold uppercase"> *This list was last updated on 21 September 2023</p>
       <!-- boarders list in pdf format -->
      <embed src="docu/New_Boarders.pdf#view=FitH`" class="w-full h-screen mt-10"  type="application/pdf" />
    </div>
